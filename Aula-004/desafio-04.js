...
console.log(isTruthy('Fernando')); // true
console.log(isTruthy([])); // true
console.log(isTruthy({})); // true
console.log(isTruthy(function () {})); // true
console.log(isTruthy('Curso JS Ninja')); // true
console.log(isTruthy(20 * 30)); // true
console.log(isTruthy(10 + 10)); // true
console.log(isTruthy([1, 2, 3])); // true
console.log(isTruthy({ a: 1, b: 2 })); // true
...
console.log(carro.obterMarcaModelo()); // Esse carro é um Fiat Bravo
