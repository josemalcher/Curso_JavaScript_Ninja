(function (win, doc) {
    ...
    */
    function sum() {
        ...
        return Array.prototype.reduce.call(arguments, function (accumulated, acutualItem) {
            //return accumulated + acutualItem;
            //return +accumulated + +acutualItem;
            return Number(accumulated) + Number(acutualItem);
        })
    }
    ...
    */
    ...
    //console.log(justNumbers('1 jos3 ,3 ,4'))
