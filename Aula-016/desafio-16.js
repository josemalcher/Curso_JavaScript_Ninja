(function () {
    ...
    */
    ...
    var nome = 'José Malcher';
    for (var i = 0, len = nome.length; i < len; i++ ) {
        console.log(nome[i] + ' é a ' + (i + 1) + ' ª letra do meu nome.');
    }
    ...
    */
    ...
    var fullName = 'José-Malcher-Junior';
    ...
    */
    console.log('\nMeus amigos:');
    var friends = ['Paulo', 'Marcos', 'Maria', 'Felipe'];
    ...
    */
    ...
    for(var i = 0 , len = myName.length ; i < len ; i++){
        myNewMame.push( i % 2 === 0 ? myName[i].toLowerCase() : myName[i].toUpperCase());
    }
    console.log(myNewMame.join(''));
